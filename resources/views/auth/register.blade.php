      ...
      <section class="section-register--right">
        ...
        @csrf
          <div class="mt-3">
            ...
            <input id="name" type="text" class="form-control u-box-shadow-1 @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
          ...
          <div class="mt-3">
            ...
            <input id="email" type="email" class="form-control u-box-shadow-1 @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email">
          ...
          <div class="mt-3">
            ...
            <input id="password" type="password" class="form-control u-box-shadow-1 @error('password') is-invalid @enderror" name="password" required autocomplete="new-password">
